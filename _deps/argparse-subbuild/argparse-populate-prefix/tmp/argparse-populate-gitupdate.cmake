...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "f5ea927f6b3beae2ac924ffde27f570bb9a7d294"
  WORKING_DIRECTORY "C:/Paradise/server/_deps/argparse-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "f5ea927f6b3beae2ac924ffde27f570bb9a7d294")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("f5ea927f6b3beae2ac924ffde27f570bb9a7d294" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/f5ea927f6b3beae2ac924ffde27f570bb9a7d294")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Paradise/server/_deps/argparse-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Paradise/server/_deps/argparse-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
