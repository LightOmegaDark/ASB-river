...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "74ca09bff89bc8de1f7b8bf3faaa6275ce23b4c5"
  WORKING_DIRECTORY "C:/Paradise/server/_deps/efsw-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Paradise/server/_deps/efsw-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Paradise/server/_deps/efsw-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
