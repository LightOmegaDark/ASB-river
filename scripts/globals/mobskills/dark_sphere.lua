...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    xi.mobskills.mobStatusEffectMove(mob, target, typeEffect, 20, 0, 300)

    local info = xi.mobskills.mobMagicalMove(mob, target, skill, mob:getMobWeaponDmg(xi.slot.MAIN), xi.magic.ele.DARK, dmgmod, xi.mobskills.magicalTpBonus.MAB_BONUS, 0, 0, 3, 3.5, 4)
