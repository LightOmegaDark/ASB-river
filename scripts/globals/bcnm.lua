...
local function checkReqs(player, npc, bfid, registrant)
    ...
    local registerReqs =
    {
        ...
        [ 419] = function() return ( player:hasKeyItem(xi.ki.RAINBOW_RESONATOR) and not player:hasKeyItem(xi.ki.EYE_OF_GALES)                                              ) end, -- Quest: Waking the Beast
        ...
        [ 451] = function() return ( player:hasKeyItem(xi.ki.RAINBOW_RESONATOR) and not player:hasKeyItem(xi.ki.EYE_OF_STORMS)                                             ) end, -- Quest: Waking the Beast
        ...
        [ 483] = function() return ( player:hasKeyItem(xi.ki.RAINBOW_RESONATOR) and not player:hasKeyItem(xi.ki.EYE_OF_FROST)                                              ) end, -- Quest: Waking the Beast
        ...
        [ 546] = function() return ( player:hasKeyItem(xi.ki.RAINBOW_RESONATOR) and not player:hasKeyItem(xi.ki.EYE_OF_FLAMES)                                             ) end, -- Quest: Waking the Beast
        ...
        [ 579] = function() return ( player:hasKeyItem(xi.ki.RAINBOW_RESONATOR) and not player:hasKeyItem(xi.ki.EYE_OF_TREMORS)                                            ) end, -- Quest: Waking the Beast
        ...
        [ 610] = function() return ( player:hasKeyItem(xi.ki.RAINBOW_RESONATOR) and not player:hasKeyItem(xi.ki.EYE_OF_TIDES)                                             ) end, -- Quest: Waking the Beast
