...
xi.job_utils.ranger.useVelocityShot = function(player, target, ability)
	player:addStatusEffect(xi.effect.VELOCITY_SHOT, 1, 0, 7200)
end

xi.job_utils.ranger.useSharpshot = function(player, target, ability)
...
xi.job_utils.ranger.useCamouflage = function(player, target, ability)
...
xi.job_utils.ranger.useBarrage = function(player, target, ability)
...
xi.job_utils.ranger.useUnlimitedShot = function(player, target, ability)
    player:addStatusEffect(xi.effect.UNLIMITED_SHOT, 1, 0, 60)
end

xi.job_utils.ranger.useFlashyShot = function(player, target, ability)
    return 0, 0 -- Not implemented yet
end

xi.job_utils.ranger.useStealthShot = function(player, target, ability)
    return 0, 0 -- Not implemented yet
end

xi.job_utils.ranger.useDoubleShot = function(player, target, ability)
    player:addStatusEffect(xi.effect.DOUBLE_SHOT, 40, 0, 90)
end

xi.job_utils.ranger.useBountyShot = function(player, target, ability)
    return 0, 0 -- Not implemented yet
end

xi.job_utils.ranger.useDecoyShot = function(player, target, ability)
    target:addStatusEffect(xi.effect.DECOY_SHOT, 11, 1, 30)
end

xi.job_utils.ranger.useHoverShot = function(player, target, ability)
    return 0, 0 -- Not implemented yet
end

xi.job_utils.ranger.useOverkill = function(player, target, ability)
