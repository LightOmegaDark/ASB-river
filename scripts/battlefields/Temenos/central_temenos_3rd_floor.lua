...
content.loot =
{
    [ID.CENTRAL_TEMENOS_3RD_FLOOR.npc.LOOT_CRATE] =
    {
...

        {
            ...
            { item = xi.items.SQUARE_OF_BENEDICT_SILK, weight = xi.loot.weight.LOW }, -- WHM
            { item = xi.items.SQUARE_OF_DIABOLIC_SILK, weight = xi.loot.weight.LOW }, -- BLM
            { item = xi.items.SPOOL_OF_RUBY_SILK_THREAD, weight = xi.loot.weight.LOW }, -- RDM
            { item = xi.items.SQUARE_OF_BRILLIANTINE, weight = xi.loot.weight.LOW }, -- SCH
        },

        {
            { item = xi.items.NONE, weight = xi.loot.weight.VERY_HIGH },
            { item = xi.items.SPOOL_OF_COILED_YARN, weight = xi.loot.weight.LOW }, -- BRD
            { item = xi.items.SPOOL_OF_CHAMELEON_YARN, weight = xi.loot.weight.LOW }, -- SMN
            { item = xi.items.PLAITED_CORD, weight = xi.loot.weight.LOW }, -- NIN
            { item = xi.items.SPOOL_OF_LUMINIAN_THREAD, weight = xi.loot.weight.LOW }, -- BLU
        },

        {
            { item = xi.items.NONE, weight = xi.loot.weight.VERY_HIGH },
            { item = xi.items.DARK_ORICHALCUM_INGOT, weight = xi.loot.weight.LOW }, -- DRK
            { item = xi.items.SPOOL_OF_GLITTERING_YARN, weight = xi.loot.weight.LOW }, -- SMN
            { item = xi.items.SHEET_OF_COBALT_MYTHRIL, weight = xi.loot.weight.LOW }, -- DRG
            { item = xi.items.PANTIN_WIRE, weight = xi.loot.weight.LOW }, -- PUP
        },
