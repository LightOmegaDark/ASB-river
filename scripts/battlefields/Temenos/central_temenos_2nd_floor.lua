...
content.loot =
{
    [ID.CENTRAL_TEMENOS_2ND_FLOOR.npc.LOOT_CRATE] =
    {
...

        {
            ...
            { item = xi.items.UTOPIAN_GOLD_THREAD, weight = xi.loot.weight.LOW }, -- MNK
            { item = xi.items.SQUARE_OF_SUPPLE_SKIN, weight = xi.loot.weight.LOW }, -- THF
            { item = xi.items.SPOOL_OF_SCARLET_ODOSHI, weight = xi.loot.weight.LOW }, -- SAM
            { item = xi.items.SPOOL_OF_SILKWORM_THREAD, weight = xi.loot.weight.LOW }, -- COR
        },
