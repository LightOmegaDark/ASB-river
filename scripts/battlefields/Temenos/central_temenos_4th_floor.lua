...
content.loot =
{
    [1] =
    {
        ...
        {
            quantity = 2,
            { item = xi.items.SQUARE_OF_ECARLATE_CLOTH, weight = xi.loot.weight.NORMAL }, -- WAR
            { item = xi.items.UTOPIAN_GOLD_THREAD, weight = xi.loot.weight.NORMAL }, -- MNK
            { item = xi.items.SQUARE_OF_BENEDICT_SILK, weight = xi.loot.weight.NORMAL }, -- WHM
            { item = xi.items.SQUARE_OF_DIABOLIC_SILK, weight = xi.loot.weight.NORMAL }, -- BLM
            { item = xi.items.SPOOL_OF_RUBY_SILK_THREAD, weight = xi.loot.weight.NORMAL }, -- RDM
            { item = xi.items.SQUARE_OF_SUPPLE_SKIN, weight = xi.loot.weight.NORMAL }, -- THF
            { item = xi.items.CHUNK_OF_SNOWY_CERMET, weight = xi.loot.weight.NORMAL }, -- PLD
            { item = xi.items.DARK_ORICHALCUM_INGOT, weight = xi.loot.weight.NORMAL }, -- DRK
            { item = xi.items.SQUARE_OF_SMALT_LEATHER, weight = xi.loot.weight.NORMAL }, -- BST
            { item = xi.items.SPOOL_OF_COILED_YARN, weight = xi.loot.weight.NORMAL }, -- BRD
            { item = xi.items.SPOOL_OF_CHAMELEON_YARN, weight = xi.loot.weight.NORMAL }, -- RNG
            { item = xi.items.SPOOL_OF_SCARLET_ODOSHI, weight = xi.loot.weight.NORMAL }, -- SAM
            { item = xi.items.PLAITED_CORD, weight = xi.loot.weight.NORMAL }, -- NIN
            { item = xi.items.SHEET_OF_COBALT_MYTHRIL, weight = xi.loot.weight.NORMAL }, -- DRG
            { item = xi.items.SPOOL_OF_GLITTERING_YARN, weight = xi.loot.weight.NORMAL }, -- SMN
            { item = xi.items.SPOOL_OF_LUMINIAN_THREAD, weight = xi.loot.weight.NORMAL }, -- BLU
            { item = xi.items.SPOOL_OF_SILKWORM_THREAD, weight = xi.loot.weight.NORMAL }, -- COR
            { item = xi.items.PANTIN_WIRE, weight = xi.loot.weight.NORMAL }, -- PUP
            { item = xi.items.SQUARE_OF_FILET_LACE, weight = xi.loot.weight.NORMAL }, -- DNC
            { item = xi.items.SQUARE_OF_BRILLIANTINE, weight = xi.loot.weight.NORMAL }, -- SCH
        },
    },
