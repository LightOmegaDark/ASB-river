...
zones[xi.zone.BEHEMOTHS_DOMINION] =
{
    text =
    {
        ...
        SYMBOLS_INSCRIBED        = 7316,  -- There are some symbols inscribed upon it.
        EXAMINE_FURTHER          = 7317,  -- Examine further? Yes/No
        NOISE_BEHIND_YOU         = 7318,  -- You hear a noise behind you.
