...
zones[xi.zone.QUFIM_ISLAND] =
{
    text =
    {
        ...
        GIGANTIC_FOOTPRINT             = 7832,  -- There is a gigantic footprint here.
        ASA_SNOW                       = 7845,  -- You see the following words scrawled into the snow: Shantotto Empire Provisional Headquarters.
        ...
        DYNA_NPC_DEFAULT_MESSAGE       = 7982,  -- There is a strange symbol drawn here. A haunting chill sweeps through you as you gaze upon it...
        PLAYER_OBTAINS_ITEM            = 8056,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM          = 8057,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM       = 8058,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP           = 8059,  -- You already possess that temporary item.
        NO_COMBINATION                 = 8064,  -- You were unable to enter a combination.
        UNITY_WANTED_BATTLE_INTERACT   = 8126,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED              = 10340, -- New training regime registered!
        LEARNS_SPELL                   = 12658, -- <name> learns <spell>!
        UNCANNY_SENSATION              = 12660, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL          = 12667, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        HOMEPOINT_SET                  = 12709, -- Home point set!
    },
    mob =
    {
        SLIPPERY_SUCKER_PH =
