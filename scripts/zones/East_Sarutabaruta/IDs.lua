...
zones[xi.zone.EAST_SARUTABARUTA] =
{
    text =
    {
        ...
        SMILEBRINGER_START            = 11097, -- So, are you ready-steady? Beginner level training...GO! Come on, pump those legs like there's no tomorrow!
        SMILEHELPER_IDLE              = 11125, -- This is a checkpointaru for the Smilebringer Boot camp. To learny-wearn more, please speak with the smile sergeant posted by the town entrance.
        SMILEHELPER_CHECKPOINT_1      = 11119, -- Checkpoint <number> cleared, Elasped time: [minutes], [seconds]
        SMILEHELPER_CHECKPOINT_2      = 11120, -- Checkpoint <number> cleared! You gain the effect of Flee. Elasped time: [minutes], [seconds]
        SMILEHELPER_ALREADY_VISITED   = 11121, -- You have already cleared this checkpoint. Elapsed time: [minutes], [seconds]
