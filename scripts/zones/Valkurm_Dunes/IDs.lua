...
zones[xi.zone.VALKURM_DUNES] =
{
    text =
    {
        ...
        NO_LONGER_FEEL_CHILL           = 7861,  -- You no longer feel a chill. The chart may lose its power if you venture too far.
        TOO_MUCH_TIME_PASSED           = 7862,  -- Too much time has passed. The monster has lost interest.
