...
zones[xi.zone.NORTH_GUSTABERG] =
{
    text =
    {
        ...
        ITEMS_ITEMS_LA_LA             = 7845,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7851,  -- The Goblin slipped away when you were not looking...
        GARRISON_BASE                 = 7861,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        PLAYER_OBTAINS_ITEM           = 8076,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8077,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8078,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8079,  -- You already possess that temporary item.
        NO_COMBINATION                = 8084,  -- You were unable to enter a combination.
        VOIDWALKER_DESPAWN            = 8115,  -- The monster fades before your eyes, a look of disappointment on its face.
        REGIME_REGISTERED             = 10406, -- New training regime registered!
        VOIDWALKER_NO_MOB             = 11525, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 11526, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 11527, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 11528, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 11530, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 11531, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 11532, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 11533, -- Obtained key item: <keyitem>!
        COMMON_SENSE_SURVIVAL         = 12479, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
        STINGING_SOPHIE_PH  =
