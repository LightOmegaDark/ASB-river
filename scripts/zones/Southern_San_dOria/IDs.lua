...
zones[xi.zone.SOUTHERN_SAN_DORIA] =
{
    text =
    {
        ...
        REVIVAL_TREE_ROOT              = 7869,  -- Go to King Ranperre's Tomb and bring back Revival Tree Root...
        ...
        WAY_OF_THE_SWORD               = 8015,  -- The way of the sword is the way of action! Now, go!
