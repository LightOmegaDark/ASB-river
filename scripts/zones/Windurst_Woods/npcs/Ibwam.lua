...
entity.onTrade = function(player, npc, trade)
    if npcUtil.tradeHas(trade, {{65535, 300}}) and player:getQuestStatus(xi.quest.log_id.WINDURST, xi.quest.id.windurst.LURE_OF_THE_WILDCAT) == QUEST_COMPLETED and player:getCurrentMission(xi.mission.log_id.TOAU) > xi.mission.id.toau.IMMORTAL_SENTRIES then
