...
entity.onTrigger = function(player, npc)
    ...
    elseif (player:getFameLevel(xi.quest.fame_area.BASTOK) > 4 and player:getQuestStatus(xi.quest.log_id.BASTOK, xi.quest.id.bastok.WISH_UPON_A_STAR) == QUEST_AVAILABLE) then -- Quest: Wish Upon a Star - Start quest.
