...
require('modules/era/lua_dynamis/zone_files/dynamis_sandoria')
...
xi.dynamis.dynaIDLookup = -- Used to check for different IDs based on zoneID. Replaces the need to overwrite IDs.lua for each zone.
{
    ...
    [xi.zone.BASTOK_MINES] = -- zoneID for array lookup
    {
        ...
        {
            -- ID Shift
            CONNECTING_WITH_THE_SERVER  = 11751, -- Connecting with server. Please wait.≺Possible Special Code: 00≻
            UNABLE_TO_CONNECT           = 11752, -- Unable to connect.≺Prompt≻
            ANOTHER_GROUP               = 11754, -- Another group of player characters is currently occupying Dynamis - ≺Multiple Choice (Parameter 0)≻[Dummy/San d'Oria/Bastok/Windurst/Jeuno/Beaucedine/Xarcabard/Valkurm/Buburimu/Qufim/Tavnazia].≺Prompt≻
            INFORMATION_RECORDED        = 11755, -- The time and destination for your foray into Dynamis has been recorded on your <itemID>.
        },
    },
    ...
    [xi.zone.BEAUCEDINE_GLACIER] = -- zoneID for array lookup
    {
        ...
        {
            -- ID Shift
            CONNECTING_WITH_THE_SERVER  = 7870, -- Connecting with server. Please wait.≺Possible Special Code: 00≻
            UNABLE_TO_CONNECT           = 7871, -- Unable to connect.≺Prompt≻
            ANOTHER_GROUP               = 7873, -- Another group of player characters is currently occupying Dynamis - ≺Multiple Choice (Parameter 0)≻[Dummy/San d'Oria/Bastok/Windurst/Jeuno/Beaucedine/Xarcabard/Valkurm/Buburimu/Qufim/Tavnazia].≺Prompt≻
            INFORMATION_RECORDED        = 7874, -- The time and destination for your foray into Dynamis has been recorded on your <itemID>.
        },
    },
    ...
    [xi.zone.BUBURIMU_PENINSULA] = -- zoneID for array lookup
    {
        ...
        {
            -- ID Shift
            CONNECTING_WITH_THE_SERVER  = 7895, -- Connecting with server. Please wait.≺Possible Special Code: 00≻
            UNABLE_TO_CONNECT           = 7896, -- Unable to connect.≺Prompt≻
            ANOTHER_GROUP               = 7898, -- Another group of player characters is currently occupying Dynamis - ≺Multiple Choice (Parameter 0)≻[Dummy/San d'Oria/Bastok/Windurst/Jeuno/Beaucedine/Xarcabard/Valkurm/Buburimu/Qufim/Tavnazia].≺Prompt≻
            INFORMATION_RECORDED        = 7899, -- The time and destination for your foray into Dynamis has been recorded on your <itemID>.
        },
    },
    ...
    [xi.zone.QUFIM_ISLAND] = -- zoneID for array lookup
    {
        ...
        {
            -- ID Shift
            CONNECTING_WITH_THE_SERVER  = 7853, -- Connecting with server. Please wait.≺Possible Special Code: 00≻
            UNABLE_TO_CONNECT           = 7854, -- Unable to connect.≺Prompt≻
            ANOTHER_GROUP               = 7856, -- Another group of player characters is currently occupying Dynamis - ≺Multiple Choice (Parameter 0)≻[Dummy/San d'Oria/Bastok/Windurst/Jeuno/Beaucedine/Xarcabard/Valkurm/Buburimu/Qufim/Tavnazia].≺Prompt≻
            INFORMATION_RECORDED        = 7857, -- The time and destination for your foray into Dynamis has been recorded on your <itemID>.
        },
    },
    ...
    [xi.zone.RULUDE_GARDENS] = -- zoneID for array lookup
    {
        ...
        {
            -- ID Shift
            CONNECTING_WITH_THE_SERVER  = 11235, -- Connecting with server. Please wait.≺Possible Special Code: 00≻
            UNABLE_TO_CONNECT           = 11236, -- Unable to connect.≺Prompt≻
            ANOTHER_GROUP               = 11238, -- Another group of player characters is currently occupying Dynamis - ≺Multiple Choice (Parameter 0)≻[Dummy/San d'Oria/Bastok/Windurst/Jeuno/Beaucedine/Xarcabard/Valkurm/Buburimu/Qufim/Tavnazia].≺Prompt≻
            INFORMATION_RECORDED        = 11239, -- The time and destination for your foray into Dynamis has been recorded on your <itemID>.
        },
    },
    ...
    [xi.zone.TAVNAZIAN_SAFEHOLD] = -- zoneID for array lookup
    {
        ...
        {
            -- ID Shift
            CONNECTING_WITH_THE_SERVER  = 11835, -- Connecting with server. Please wait.≺Possible Special Code: 00≻
            UNABLE_TO_CONNECT           = 11836, -- Unable to connect.≺Prompt≻
            ANOTHER_GROUP               = 11838, -- Another group of player characters is currently occupying Dynamis - ≺Multiple Choice (Parameter 0)≻[Dummy/San d'Oria/Bastok/Windurst/Jeuno/Beaucedine/Xarcabard/Valkurm/Buburimu/Qufim/Tavnazia].≺Prompt≻
            INFORMATION_RECORDED        = 11839, -- The time and destination for your foray into Dynamis has been recorded on your <itemID>.
        },
    },
    [xi.zone.VALKURM_DUNES] = -- zoneID for array lookup
    {
        ...
        {
            -- ID Shift
            CONNECTING_WITH_THE_SERVER  = 7869, -- Connecting with server. Please wait.≺Possible Special Code: 00≻
            UNABLE_TO_CONNECT           = 7870, -- Unable to connect.≺Prompt≻
            ANOTHER_GROUP               = 7872, -- Another group of player characters is currently occupying Dynamis - ≺Multiple Choice (Parameter 0)≻[Dummy/San d'Oria/Bastok/Windurst/Jeuno/Beaucedine/Xarcabard/Valkurm/Buburimu/Qufim/Tavnazia].≺Prompt≻
            INFORMATION_RECORDED        = 7873, -- The time and destination for your foray into Dynamis has been recorded on your <itemID>.
        },
    },
    ...
    [xi.zone.XARCABARD] = -- zoneID for array lookup
    {
        ...
        {
            -- ID Shift
            CONNECTING_WITH_THE_SERVER  = 7850, -- Connecting with server. Please wait.≺Possible Special Code: 00≻
            UNABLE_TO_CONNECT           = 7851, -- Unable to connect.≺Prompt≻
            ANOTHER_GROUP               = 7853, -- Another group of player characters is currently occupying Dynamis - ≺Multiple Choice (Parameter 0)≻[Dummy/San d'Oria/Bastok/Windurst/Jeuno/Beaucedine/Xarcabard/Valkurm/Buburimu/Qufim/Tavnazia].≺Prompt≻
            INFORMATION_RECORDED        = 7854, -- The time and destination for your foray into Dynamis has been recorded on your <itemID>.
        },
    },
    ---------------------------------------------
    --              Dynamis Zones             --
    ...
    [xi.zone.DYNAMIS_BASTOK] = -- zoneID for array lookup
    {
        text = -- text for table lookup
        {
            NO_LONGER_HAVE_CLEARANCE = 7068, -- ---== WARNING ==---- You no longer have clearance to remain in Dynamis. You will be transported out in ≺Numeric Parameter 1≻ ≺Singular/Plural Choice (Parameter 1)≻[second/seconds].≺Prompt≻
        },
    ...
    [xi.zone.DYNAMIS_BEAUCEDINE] = -- zoneID for array lookup
    {
        text = -- text for table lookup
        {
            NO_LONGER_HAVE_CLEARANCE = 7168, -- ---== WARNING ==---- You no longer have clearance to remain in Dynamis. You will be transported out in ≺Numeric Parameter 1≻ ≺Singular/Plural Choice (Parameter 1)≻[second/seconds].≺Prompt≻
        },
    ...
    [xi.zone.DYNAMIS_BUBURIMU] = -- zoneID for array lookup
    {
        text = -- text for table lookup
        {
            NO_LONGER_HAVE_CLEARANCE = 7327, -- ---== WARNING ==---- You no longer have clearance to remain in Dynamis. You will be transported out in ≺Numeric Parameter 1≻ ≺Singular/Plural Choice (Parameter 1)≻[second/seconds].≺Prompt≻
        },
...
--]]
local dynaSand = xi.zonesCustom[xi.zone.DYNAMIS_SAN_DORIA]
...
xi.dynamis.handleDynamis = function(zone)
    ...
    local noPlayerTimer = zone:getLocalVar(string.format('[DYNA]NoPlayerTimer_%s', zoneID))
    local sysClock = os.time()
    local parentZone = GetZone(xi.dynamis.dynaIDLookup[zoneID].entryZone)
    local zoneCooldown = parentZone:getLocalVar(string.format('[DYNA]ZoneCooldown_%s', zoneID))
    local cleanupScript = parentZone:getLocalVar(string.format('[DYNA]CleanupScript_%s', zoneID))
    ...
    for _, player in pairs(playersInZone) do -- Iterates through player list to do stuff.
        if player:getLocalVar('Requires_Initial_Update') == 0 then
            ...
            for _, zone_ID in pairs(dreamlands) do
                if zone_ID == zoneID and zone:getLocalVar('SJUnlock') ~= 1 then
                    local savedStatusEffects = { xi.effect.RERAISE, xi.effect.SIGIL, xi.effect.SIGNET, xi.effect.SANCTION, xi.effect.SJ_RESTRICTION, xi.effect.FOOD, xi.effect.BATTLEFIELD, xi.effect.DEDICATION }
                    ...
                    for _, targetEffect in pairs(targetStatusEffects) do -- For Each Status Effect on the Player
                        ...
                        local effectID = targetEffect:getEffectType()
        ...
        if
            ...
            player:getLocalVar('[DYNA]NextHourglassCheck') < sysClock  -- GMs can stay in zone until expiry.
        then
            ...
            if hasValidHourglass then
                player:setLocalVar('[DYNA]NextHourglassCheck', sysClock + 5)
            end
        end
    end
    ...
    if
        zone1Min == 0 and
        zoneTimeRemaining < 80 and
        cleanupScript == 0
    then -- If now is < 1:20 minutes give warning.
    ...
    elseif
        zone3Min == 0 and
        zoneTimeRemaining < 200 and
        cleanupScript == 0
    then -- If now is < 3:20 minutes give warning.
        xi.dynamis.dynamisTimeWarning(zone, zoneTimepoint) -- Send time warning.
        zone:setLocalVar(string.format('[DYNA]Given3MinuteWarning_%s', zoneID), 1) -- Sets to true to not give another warning.
    elseif
        zone10Min == 0 and
        zoneTimeRemaining < 620 and
        cleanupScript == 0
    then -- If now is < 10:20 minutes give warning.
        xi.dynamis.dynamisTimeWarning(zone, zoneTimepoint) -- Send time warning.
        zone:setLocalVar(string.format('[DYNA]Given10MinuteWarning_%s', zoneID), 1) -- Sets to true to not give another warning.
    end

    if zoneTimeRemaining <= 1 then          -- If the zone timer has 1s remaining
        xi.dynamis.ejectAllPlayers(zone)    -- Start removing players (they have 30s to sort loot)
        if                                  -- Also, if....
            cleanupScript == 0 and          -- No cleanup has run
            zoneCooldown == 0               -- No 90s CD Timer is set
        then                                -- Set the timer and run the cleanup
            parentZone:setLocalVar(string.format('[DYNA]ZoneCooldown_%s', zoneID), sysClock + 90)
            xi.dynamis.cleanupDynamis(zone)
        end
    end

    -- Handle no players in zone
    if                                  -- If....
        #playersInZone == 0 and         -- No player in zone
        noPlayerTimer == 0 and          -- No Timer has been set
        cleanupScript == 0              -- No cleanup script has run
    then                                -- Give 4m:55s for zone to repopulate.
        -- NOTE: We do 5sec less than 5min to prevent zone idle from happening before cleanup fired
        zone:setLocalVar(string.format('[DYNA]NoPlayerTimer_%s', zoneID), sysClock + 295)
    elseif                              -- Otherwise....
        #playersInZone > 0 and          -- If players have zoned back in
        noPlayerTimer ~= 0              -- And there is a timer set
    then                                -- Reset the timer so zone doesnt close on the players
        zone:setLocalVar(string.format('[DYNA]NoPlayerTimer_%s', zoneID), 0)
    end

    if                                  -- If....
        noPlayerTimer > 0 and           -- the timer has been set
        noPlayerTimer <= sysClock and   -- And the timer has expired
        cleanupScript == 0 and          -- And the cleanup hasnt already run
        zoneCooldown == 0               -- And the 90s CD Timer has not started
    then                                -- Set the timer and run the cleanup
        parentZone:setLocalVar(string.format('[DYNA]ZoneCooldown_%s', zoneID), sysClock + 90)
        xi.dynamis.cleanupDynamis(zone)
    end
...
xi.dynamis.addMinutesToDynamis = function(zone, minutes)
    ...
    if timeRemaining > 620 then -- Checks if time remaining > 11 minutes.
        zone:setLocalVar(string.format('[DYNA]Given10MinuteWarning_%s', zoneID), 0) -- Resets var if time remaining greater than threshold.
    end

    if timeRemaining > 200 then -- Checks if time remaining > 4 minutes.
        zone:setLocalVar(string.format('[DYNA]Given3MinuteWarning_%s', zoneID), 0) -- Resets var if time remaining greater than threshold.
    end

    if timeRemaining > 80 then -- Checks if time remaining > 2 minutes.
        zone:setLocalVar(string.format('[DYNA]Given1MinuteWarning_%s', zoneID), 0) -- Resets var if time remaining greater than threshold.
    end
end
...
xi.dynamis.despawnAll = function(zone)
    print('[] despawnAll zoneID: ' .. tostring(zone:getID()))
...
xi.dynamis.registerDynamis = function(player)
    ...
    parentZone:setLocalVar(string.format('[DYNA]CleanupScript_%s', xi.dynamis.dynaInfoEra[zoneID].dynaZone), 0)
    ...
    dynaZone:setLocalVar(string.format('[DYNA]Token_%s', xi.dynamis.dynaInfoEra[zoneID].dynaZone), dynamisToken)
    dynaZone:setLocalVar(string.format('[DYNA]InstanceID_%s', xi.dynamis.dynaInfoEra[zoneID].dynaZone), instanceID)
    dynaZone:setLocalVar(string.format('[DYNA]CurrentWave_%s', zoneID), 1)
...
xi.dynamis.registerPlayer = function(player)
    ...
    player:setCharVar('DynaEnterCount', player:getCharVar('DynaEnterCount') + 1)
    player:setCharVar('DynaNextReset', NextConquestTally())
...
xi.dynamis.isPlayerLockedOut = function(player)
    ...
    local lockoutCount = 2
    local playerRes = player:getCharVar('DynaEnterCount')
    local isReset = os.time() >= player:getCharVar('DynaNextReset')

    if isReset then
        player:setCharVar('DynaEnterCount', 0)
        return lockedOut
    end

    if playerRes >= lockoutCount then
        lockedOut = true
    end
...
xi.dynamis.entryNpcOnTrade = function(player, npc, trade)
    ...
    local isReset = sysTime >= player:getCharVar('DynaNextReset')
    local zoneCooldown = zone:getLocalVar(string.format('[DYNA]ZoneCooldown_%s', xi.dynamis.dynaInfoEra[zoneID].dynaZone))
    local cleanupScript = zone:getLocalVar(string.format('[DYNA]CleanupScript_%s', zoneID))
    ...
    if playerRes >= lockoutCount and not isReset then
        lockedOut = true
    end
    ...
    then
        ...
        elseif checkGM(player) then -- If no other group, if GM bypass lockout and start new dynamis.
            zone:setLocalVar(string.format('[DYNA]ZoneCooldown_%s', xi.dynamis.dynaInfoEra[zoneID].dynaZone), 0)
        ...
        elseif lockedOut then -- Still in lockout period.
            -- local span = NextConquestTally()
            -- span = span / 60
            -- player:messageSpecial(zones[zoneID].text.YOU_CANNOT_ENTER_DYNAMIS, math.ceil(span), xi.dynamis.entryInfoEra[zoneID].csBit)
            player:PrintToPlayer('You can\'t enter dynamis again until the next conquest reset.', xi.msg.channel.NS_SAY)
        elseif
            zoneCooldown > sysTime and
            cleanupScript ~= 1
        then
            player:messageSpecial(xi.dynamis.dynaIDLookup[zoneID].text.ANOTHER_GROUP, xi.dynamis.entryInfoEra[zoneID].csBit)
...
xi.dynamis.entryNpcOnEventUpdate = function(player, csid, option)
    ...
    if csid == xi.dynamis.entryInfoEra[zoneID].csRegisterGlass then -- If dynamis register glass cs.
        ...
        if option == 0 and dynamisTimeRemaining <= 0 then -- If completes the cutscene.
