...
-----------------------------------
-- local m = Module:new('dyna_sand_id_zone')

zonesCustom = zonesCustom or {}
    zonesCustom[xi.zone.DYNAMIS_SAN_DORIA] =
    {
        text =
        {
            ...
            NOTHING_OUT_OF_ORDIN4ARY       = 6404, -- There is nothing out of the ordinary here.
    ...
    return zonesCustom[xi.zone.DYNAMIS_SAN_DORIA]
-- end)
